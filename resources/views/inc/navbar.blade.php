<div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
    <h5 class="my-0 mr-md-auto font-weight-normal"><a href="/">Basic web site</a></h5>
    <nav id="navbar" class="my-2 my-md-0 mr-md-3">
        ...
        <a class="p-2 {{Request::is('listings') ? 'active' : 'not-active'}}" href="/listings">Business Listings</a>
    </nav>
</div>
